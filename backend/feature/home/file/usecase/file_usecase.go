...
type FileUsecase interface {
	...
	DownloadFiles(c context.Context, filePaths []entities.Data) ([]string, error)
...
func (uc *fileUsecase) DownloadFiles(c context.Context, filePaths []entities.Data) ([]string, error) {
